          ...
          child: Column(
            ...
            children: [
              ...
              if (payment.status == PaymentStatus.paid) ...[
                ...
                Row(
                  children: [
                    ...
                    _buildDetailItem(Icons.payment, 'Method', payment.methodDisplay),
                  ],
                ),
                if (payment.transactionId != null) ...[
                  const SizedBox(height: 8),
                  _buildDetailItem(Icons.tag, 'Transaction ID', payment.transactionId!),
                ],
              ],
              if (payment.status == PaymentStatus.pending ||
                ...
                Row(
                  children: [
                    _buildDetailItem(Icons.event, 'Due date', _formatDate(payment.dueDate)),
                  ],
                ),
              ],
            ],
