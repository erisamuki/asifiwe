...
import 'package:asifiwe/services/momo_service.dart';
import 'package:asifiwe/services/airtel_service.dart';
...
class PaymentGatewayService {
  ...
  Future<PaymentResult> payWithMTNMomo({
    ...
    final transactionId = 'asifiwe-${DateTime.now().millisecondsSinceEpoch}';
