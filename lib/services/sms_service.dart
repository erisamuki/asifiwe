...
import 'package:asifiwe/models/user_model.dart';
import 'package:asifiwe/models/payment_model.dart';
import 'package:asifiwe/models/maintenance_model.dart';
import 'package:asifiwe/services/currency_formatter.dart';
...
class SmsService {
  ...
  Future<bool> sendWelcomeSms({
    ...
    final message =
        '''Welcome to $propertyName, ${tenant.fullName.split(' ').first}! 
You have been assigned Unit $unitNumber. 
Download the asifiwe app to manage your rent payments.
- asifiwe Team''';
  ...
  Future<bool> sendPaymentReminderSms({
    ...
    final message =
        '''Hi ${tenant.fullName.split(' ').first},
...
- asifiwe Team''';
  ...
  Future<bool> sendOverdueReminderSms({
    ...
    final message =
        '''URGENT: Hi ${tenant.fullName.split(' ').first},
...
Check the asifiwe app for details.
- asifiwe Team''';
